...
export default function SettingsPage() {
    ...
    const fetchInventory = async () => {
        setLoading(true);
        try {
            const res = await fetch("http://factoryerp.uz" + '/api/inventory');
    ...
    const handleSave = async (id: string) => {
        try {
            ...
            const response = await fetch(`http://factoryerp.uz/api/inventory/${id}`, {
                method: 'PUT',
    ...
    const handleApplyGlobalLimit = async () => {
        ...
        try {
            const res = await fetch("http://factoryerp.uz" + '/api/inventory/global-limit', {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleResetAllStock = async () => {
        ...
        try {
            const res = await fetch("http://factoryerp.uz" + '/api/inventory/reset-stock', { method: 'PUT' });
            if (res.ok) {
